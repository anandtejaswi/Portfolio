...
export default function Anomalyze({ locked }: { locked?: boolean }) {
    ...
    return (
        <Card className='group relative bg-[#101928]'>
            ...
            <div className='absolute top-4 left-4 font-bold text-white z-10 text-xl tracking-wider'>Anomalyze</div>
        </Card>
    );
}
