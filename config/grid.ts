import { Intro, Eligify, Anomalyze, SolarSwing, Certs, TryHackMe, Contact, Github, Resume, Skills, Experience } from '@/components/grid/widgets';
...
export const gridItems: GridItem[] = [
    ...
    { i: 'experience', component: Experience, category: 'about' },
];
...
export const layouts: { [key in Layouts]: Layout[] } = {
    lg: [
        ...
        { i: 'contact', x: 3, y: 4, w: 1, h: 1 },
        { i: 'experience', x: 0, y: 2, w: 2, h: 3 },
        { i: 'skills', x: 2, y: 2, w: 2, h: 2 },
        { i: 'solarswing', x: 2, y: 4, w: 1, h: 3 },
        { i: 'anomalyze', x: 0, y: 5, w: 1, h: 3 },
        { i: 'github', x: 3, y: 1, w: 1, h: 1 },
        { i: 'eligify', x: 1, y: 6, w: 1, h: 3 },
        { i: 'tryhackme', x: 2, y: 7, w: 2, h: 1 },
    ],
    md: [
        { i: 'intro', x: 0, y: 0, w: 2, h: 2 },
        { i: 'resume', x: 2, y: 0, w: 1, h: 2 },
    ...
    sm: [
        { i: 'intro', x: 0, y: 0, w: 2, h: 3 },
        { i: 'resume', x: 0, y: 3, w: 1, h: 2 },
        { i: 'certs', x: 1, y: 3, w: 1, h: 1 },
        { i: 'contact', x: 1, y: 11, w: 1, h: 1 },
        { i: 'tryhackme', x: 0, y: 5, w: 2, h: 1 },
        { i: 'experience', x: 0, y: 6, w: 2, h: 3 },
        { i: 'skills', x: 0, y: 9, w: 2, h: 2 },
        { i: 'github', x: 1, y: 4, w: 1, h: 1 },
        { i: 'solarswing', x: 0, y: 11, w: 1, h: 4 },
        { i: 'eligify', x: 1, y: 12, w: 1, h: 4 },
        { i: 'anomalyze', x: 0, y: 15, w: 1, h: 4 },
    ],
    xs: [
        { i: 'intro', x: 0, y: 0, w: 2, h: 3 },
        { i: 'resume', x: 0, y: 3, w: 1, h: 2 },
