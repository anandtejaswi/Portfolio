...
export default function FilterableGrid() {
    ...
    const pillBase = 'px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200';
    ...
    return (
        <div className='flex flex-col gap-4'>
            ...
            {/* ── Navigation bar ── */}
            <nav className='sticky top-3 z-50 mx-auto flex w-fit items-center gap-1 rounded-full border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-[#111]/80 backdrop-blur-md px-2 py-1.5 shadow-sm'>
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-medium border transition-all duration-200 ${
                        locked
                            ...
                            : 'border-gray-300 dark:border-gray-600 text-gray-500 dark:text-gray-400 hover:border-gray-500 dark:hover:border-gray-400'
                    }`}
                ...
                <a
                    ...
                    className='group flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors rounded-full'
                >
                    Contact
