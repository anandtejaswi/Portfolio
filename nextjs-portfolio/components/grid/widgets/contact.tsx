    ...
    return (
        <Card className='flex flex-col justify-center gap-2 md:gap-3 p-3 min-[380px]:p-4 sm:p-6 md:p-8 bg-pink-100 text-pink-950 dark:bg-[#3d1a29] dark:text-pink-100 shadow-sm'>
            ...
            <div className='flex flex-col gap-1.5 md:gap-2 mt-1'>
                <a
                    className='cancel-drag group flex items-center gap-1.5 md:gap-2 text-[11px] min-[380px]:text-[12px] sm:text-[14px] md:text-base text-pink-800 hover:text-pink-600 dark:text-pink-300 dark:hover:text-pink-100 transition-colors'
