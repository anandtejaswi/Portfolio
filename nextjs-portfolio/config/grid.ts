...
export const layouts: { [key in Layouts]: Layout[] } = {
    lg: [
        ...
        { i: 'contact', x: 3, y: 0, w: 1, h: 1 },
        { i: 'certs', x: 3, y: 1, w: 1, h: 1 },
        { i: 'tryhackme', x: 0, y: 2, w: 2, h: 1 },
        { i: 'github', x: 2, y: 2, w: 1, h: 1 },
        { i: 'anomalyze', x: 3, y: 2, w: 1, h: 3 },
        { i: 'eligify', x: 0, y: 3, w: 1, h: 3 },
        { i: 'skills', x: 1, y: 3, w: 2, h: 2 },
        { i: 'solarswing', x: 1, y: 5, w: 1, h: 3 },
    ],
    md: [
        { i: 'intro', x: 0, y: 0, w: 2, h: 2 },
        { i: 'resume', x: 2, y: 0, w: 1, h: 2 },
    ...
    sm: [
        { i: 'intro', x: 0, y: 0, w: 2, h: 2 },
        { i: 'eligify', x: 0, y: 2, w: 2, h: 3 },
        { i: 'anomalyze', x: 0, y: 5, w: 2, h: 3 },
        { i: 'solarswing', x: 0, y: 8, w: 2, h: 3 },
        { i: 'tryhackme', x: 0, y: 11, w: 2, h: 1 },
        { i: 'certs', x: 0, y: 12, w: 1, h: 1 },
        { i: 'contact', x: 1, y: 12, w: 1, h: 1 },
        { i: 'github', x: 0, y: 13, w: 1, h: 1 },
        { i: 'resume', x: 1, y: 13, w: 1, h: 2 },
        { i: 'skills', x: 0, y: 15, w: 2, h: 2 },
    ],
    xs: [
        { i: 'intro', x: 0, y: 0, w: 2, h: 2 },
        { i: 'eligify', x: 0, y: 2, w: 2, h: 3 },
